...
const CONTEXTUAL_HINTS: ContextualHint[] = [
  {
    ...
    title: "📎 开始你的第一次分析",
    content:
      "上传 PDF 论文或输入 DOI 开始分析。支持拖拽文件到此处！",
    icon: Upload,
    position: "top",
    priority: "high",
    action: {
  ...
  },
  {
    ...
    title: "🔍 发现相关论文",
    content:
      "使用右侧搜索工具查找 PubMed、Semantic Scholar 或 OpenAlex 上的文献",
    icon: Search,
    position: "left",
    priority: "medium",
  },
  {
    ...
    title: "📚 探索知识库",
    content:
      "点击左侧的创新等级或参考模块，快速了解 BME 领域知识体系",
    icon: BookOpen,
    position: "right",
    priority: "low",
  },
...
export function QuickHints() {
  ...
  const dismissWelcomeTip = React.useCallback((tipId: string) => {
